  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className={cn(
          "dark:text-foreground inline-block text-neutral-900 relative z-20 group-hover/cover:text-foreground transition duration-200",
          className
        )}
      >
        {children}
...
export const CircleIcon = ({
  ...
  return (
    <div
      className={cn(
        `pointer-events-none animate-pulse group-hover/cover:hidden group-hover/cover:opacity-100 group h-2 w-2 rounded-full bg-neutral-600 dark:bg-foreground opacity-20 group-hover/cover:bg-foreground`,
        className
      )}
    ></div>
  );

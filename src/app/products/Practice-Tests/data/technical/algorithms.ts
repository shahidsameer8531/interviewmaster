...
export const algorithmTests: Test[] = [
  {
    id: 'algo-beginner',
    title: 'Algorithm Beginner Test',
    description: 'A comprehensive beginner level test covering algorithm concepts and problem-solving strategies.',
    difficulty: 'beginner',
    timeLimit: 30,
    totalQuestions: 10,
    category: 'technical',
  ...
  },
  {
    ...
    title: 'Algorithm Intermediate Test',
    description: 'A comprehensive intermediate level test covering advanced algorithm concepts.',
  ...
  {
    id: 'algo-advanced',
    title: 'Algorithm Advanced Test',
    description: 'A comprehensive advanced level test covering complex algorithmic concepts.',
    difficulty: 'advanced',
    timeLimit: 60,
    totalQuestions: 10,
    category: 'technical',

...
export const systemDesignQuestions: Test = {
  beginner: [
    {
      ...
      explanation: 'Load balancers distribute incoming network traffic across multiple servers to ensure no single server bears too much load, improving reliability and availability.'
    },
    {
      ...
      explanation: 'In-memory databases are ideal for session storage due to their fast access times, built-in TTL support, and ability to handle high-frequency reads and writes.'
    },
    {
    ...
    },
    {
      ...
      explanation: 'Horizontal scaling (scaling out) adds more machines to your pool of resources, while vertical scaling (scaling up) adds more power to existing machines.'
    },
    {
    ...
    },
    {
      ...
      explanation: 'Microservices actually make data management more complex due to distributed data ownership and the need to maintain consistency across services.'
    },
    {
  ...
  advanced: [
    {
      text: 'How would you design a system to handle millions of real-time websocket connections?',
      options: [
        'Single server with threads',
        'Load balanced servers with sticky sessions',
        'WebSocket gateway with event mesh',
        'Traditional HTTP polling'
      ],
      correctAnswer: 'WebSocket gateway with event mesh',
      explanation: 'A WebSocket gateway with event mesh provides scalable real-time communication with proper message routing and delivery guarantees.'
    }
